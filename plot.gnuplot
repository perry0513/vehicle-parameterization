...
files = "logs/test.json_classic_scheduling_".word(norm_names, i)."_normalization_200_iters_".n."_log.csv logs/test.json_timberwolf_scheduling_".word(norm_names, i)."_normalization_200_iters_".n."_log.csv logs/test.json_fast_scheduling_".word(norm_names, i)."_normalization_200_iters_".n."_log.csv"
